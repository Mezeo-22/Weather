package com.example.weatherivanova;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_floating = findViewById(R.id.searchFloating);
        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            private void api_key(final String City) {
                ...
                Request request = new Request.Builder()
                        .url("http://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=ebc8ed8b12dd6bf263c8992eca936a32&units=metric")
                        .get()
                        .build();
